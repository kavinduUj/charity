...
import com.group.charity.domain.useCase.event.AttendUseCase
...
@HiltViewModel
class AttendEventViewModel @Inject constructor(
    private val eventDetailsUseC: AttendUseCase
): ViewModel() {
    private val _createEventStateFLow = MutableStateFlow<CommonState<AttendEvent>>(CommonState.Loading)
    val createEventStateFLow: StateFlow<CommonState<AttendEvent>> = _createEventStateFLow
